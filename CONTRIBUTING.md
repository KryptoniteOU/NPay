Contributing to NPay Core
============================

The NPay Core project operates an open contributor model where anyone is
...
The following applies to code changes to the NPay Core project, and is not to be
confused with overall NPay Network Protocol consensus changes.

Whether a pull request is merged into NPay Core rests with the project merge
...
Patches that change NPay consensus rules are considerably more involved than
...
Where a patch set proposes to change the NPay consensus, it must have been
...
The project leader is the release manager for each NPay Core release.
