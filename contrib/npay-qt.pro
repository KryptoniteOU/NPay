...
RESOURCES += src/qt/npay.qrc src/qt/npay_locale.qrc

TRANSLATIONS += src/qt/locale/npay_bg.ts \
                src/qt/locale/npay_de.ts \
                src/qt/locale/npay_en.ts \
                src/qt/locale/npay_es.ts \
                src/qt/locale/npay_fi.ts \
                src/qt/locale/npay_fr.ts \
                src/qt/locale/npay_it.ts \
                src/qt/locale/npay_ja.ts \
                src/qt/locale/npay_pl.ts \
                src/qt/locale/npay_pt.ts \
                src/qt/locale/npay_ru.ts \
                src/qt/locale/npay_sk.ts \
                src/qt/locale/npay_sv.ts \
                src/qt/locale/npay_vi.ts \
                src/qt/locale/npay_zh_CN.ts \
                src/qt/locale/npay_zh_TW.ts
