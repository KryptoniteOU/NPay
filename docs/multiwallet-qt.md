...
In order to support loading of multiple wallets in npay-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is npay.cpp.
...
Changes to npay.cpp
----------------------
npay.cpp is the entry point into npay-qt, and as such, will require some minor modifications to provide hooks for
