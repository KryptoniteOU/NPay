...
void PrivacyDialog::sendzNPAY()
{
    ...
    if(ui->payTo->text().isEmpty()){
        ...
        if (!address.IsValid()) {
            QMessageBox::warning(this, tr("Spend Zerocoin"), tr("Invalid NPay Address"), QMessageBox::Ok, QMessageBox::Ok);
            ui->payTo->setFocus();
            return;
        }
    }
    ...
    if (!ZNpayControlDialog::listSelectedMints.empty()) {
        vMintsSelected = ZNpayControlDialog::GetSelectedMints();
    }
    ...
    ZNpayControlDialog::listSelectedMints.clear();
