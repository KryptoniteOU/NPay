...
std::list<std::string> ZNpayControlDialog::listSelectedMints;
std::list<CZerocoinMint> ZNpayControlDialog::listMints;
...
void ZNpayControlDialog::updateLabels()
{
    ...
    privacyDialog->setZNpayControlLabels(nAmount, listSelectedMints.size());
}

std::vector<CZerocoinMint> ZNpayControlDialog::GetSelectedMints()
{
