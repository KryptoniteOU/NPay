                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("NPay Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a NPay address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and npay: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About NPay Core"), this);
    aboutAction->setStatusTip(tr("Show information about NPay Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for NPay"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your NPay addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified NPay addresses"));
    ...
    openAction->setStatusTip(tr("Open a NPay: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the NPay Core help message to get a list with possible NPay command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("NPay Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to NPay network", "", count));
}
...
{
    QString strTitle = tr("NPay Core"); // default title
