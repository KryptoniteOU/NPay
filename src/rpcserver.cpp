...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* NPay features */
        {"npay", "masternode", &masternode, true, true, false},
        {"npay", "listmasternodes", &listmasternodes, true, true, false},
        {"npay", "getmasternodecount", &getmasternodecount, true, true, false},
        {"npay", "masternodeconnect", &masternodeconnect, true, true, false},
        {"npay", "masternodecurrent", &masternodecurrent, true, true, false},
        {"npay", "masternodedebug", &masternodedebug, true, true, false},
        {"npay", "startmasternode", &startmasternode, true, true, false},
        {"npay", "createmasternodekey", &createmasternodekey, true, true, false},
        {"npay", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"npay", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"npay", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"npay", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"npay", "getmasternodescores", &getmasternodescores, true, true, false},
        {"npay", "mnbudget", &mnbudget, true, true, false},
        {"npay", "preparebudget", &preparebudget, true, true, false},
        {"npay", "submitbudget", &submitbudget, true, true, false},
        {"npay", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"npay", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"npay", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"npay", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"npay", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"npay", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"npay", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"npay", "checkbudgets", &checkbudgets, true, true, false},
        {"npay", "mnsync", &mnsync, true, true, false},
        {"npay", "spork", &spork, true, true, false},
        {"npay", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"npay", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use npayd, or the -server option to npay-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> npay-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:30330/\n";
}
